...
export default function BlogPage() {
  ...
  return (
    <main><Header />
      ...
      <section className="newsletter section-shell" id="newsletter"><p className="eyebrow">THE OCCASIONAL DISPATCH</p><h2>One useful idea.<br />No noise.</h2><p>Field notes on the changing sports business, delivered when there is something worth saying.</p><form action="https://buttondown.com/api/emails/embed-subscribe/neerajkjha" method="post" className="embeddable-buttondown-form"><label htmlFor="bd-email"><span>EMAIL ADDRESS</span><input type="email" name="email" id="bd-email" placeholder="you@company.com" required /></label><button type="submit">SUBSCRIBE ↗</button></form><small>No spam. Unsubscribe at any time. <a href="https://buttondown.com/refer/neerajkjha" target="_blank" rel="noreferrer">Powered by Buttondown.</a></small></section>
      <Footer />
    </main>
  );
}
